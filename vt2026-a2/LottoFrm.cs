...
namespace vt2026_a2
{
    public partial class LottoFrm : Form
    {
        ...
        private void num1Txb_TextChanged(object sender, EventArgs e)
        {
            validateTbxs();
        }

        private void num2Txb_TextChanged(object sender, EventArgs e)
        {
            validateTbxs();
        }

        private void num3Txb_TextChanged(object sender, EventArgs e)
        {
            validateTbxs();
        }

        private void num4Txb_TextChanged(object sender, EventArgs e)
        {
            validateTbxs();
        }

        private void num5Txb_TextChanged(object sender, EventArgs e)
        {
            validateTbxs();
        }

        private void num6Txb_TextChanged(object sender, EventArgs e)
        {
            validateTbxs();
        }

        private void num7Txb_TextChanged(object sender, EventArgs e)
        {
            validateTbxs();
        }

        private void ittrationTxb_TextChanged(object sender, EventArgs e)
        {
            validateTbxs();
        }
        //****************************************************************//
