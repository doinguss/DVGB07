...
namespace vt2026_a4
{
    public partial class storeFrm : Form
    {
        ...
        public storeFrm(string path)
        {
            ...
            System.Windows.Forms.Timer syncClock = new();
            syncClock.Interval = 1000 * 60;
            syncClock.Tick += new(delegate (object? o, EventArgs e) { UpdateFromDatabase(); });
            syncClock.Start();
        ...
        {
            storeControler.UpdateInfo(nameLbl, categoryLbl, stockLbl, tagsLbl, itemsLw);
        }
        ...
        private void buyBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                storeControler.Buy(shoppingcartLw, totalLbl);

                updateListbox();
                storeControler.ShowTop10(topselerLbl);
            }
            catch (Exception ex) { MessageBox.Show(ex.Message); }
        }
        ...
        {
            updateFromDatabaseToolStripMenuItem.PerformClick();
            updateListbox();
        ...
        private void updateFromDatabaseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            UpdateFromDatabase();
        }
        ...
        private void UpdateFromDatabase()
        {
            ...
            catch (Exception ex) { somethingLbl.Text += "<error> " + ex.Message + "</error>\n"; }
        }

        private void syncLocalstockToDatabaseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                storeControler.MoveOrRemove(1);
        ...
        private void showGraphsOfPriceAndAmountToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                new GraphsFrm().Show();
